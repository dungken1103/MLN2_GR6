...
const Magazine = () => {
  ...
  const handleDownloadPdf = () => {
    ...
    const opt = {
      ...
      jsPDF:        { unit: 'px', format: [636, 450], orientation: 'landscape' }
    };
  ...
  return (
    <div className="min-h-screen bg-neutral-950 flex flex-col items-center justify-center p-4 lg:p-8 font-sans">
      ...
      <div className="fixed top-0 left-[-9999px] z-[-1] opacity-0 pointer-events-none">
        <div ref={printRef} className="flex flex-col w-[636px]">
          
        {/* Page 1: Cover */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><CoverPage image="/images/nep-cover.png">
          <div className="border-l-4 border-red-600 pl-4 mb-4">
            <h1 className="text-5xl md:text-6xl font-black text-white uppercase mb-2 leading-none drop-shadow-lg">
              NEP <span className="text-red-600">1921</span>
            </h1>
        ...
        {/* Page 2: Inside Cover (Credits) */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page>
          <div className="flex flex-col h-full justify-center items-center text-center opacity-40">
            <div className="w-16 h-16 rounded-full border-2 border-red-600 flex items-center justify-center text-xl font-black mb-4 text-red-500">
              G6
            </div>
        ...
        {/* Page 3: Lời tựa / Bối cảnh */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={1}>
          <h2 className="text-3xl font-bold text-white mb-8 font-sans leading-tight">
            Khi màn đêm bao phủ <span className="text-red-500">Đế Quốc Nga</span>
          </h2>
          <p className="mb-4 text-lg leading-relaxed text-gray-300">
        ...
        {/* Page 4: Image WW1 */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><ImagePage 
          image="/images/ww1-russia.png" 
          caption="Nước Nga kiệt quệ trong những chiến hào lầy lội của Thế chiến I." 
        /></div>

        {/* Page 5: Text */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={2}>
          <h3 className="text-2xl font-bold text-red-500 mb-6 uppercase tracking-wider">
            Cách mạng Tháng Mười & Ánh sáng hy vọng
          </h3>
          <p className="mb-4 leading-relaxed text-gray-400">
        ...
        {/* Page 7: Text */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={3}>
          <h3 className="text-2xl font-bold text-white mb-6 uppercase tracking-wider">
            Chính sách "Cộng sản thời chiến"
          </h3>
          <p className="mb-4 leading-relaxed text-gray-400">
        ...
        {/* Page 9: Text */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={4}>
          <h3 className="text-2xl font-bold text-red-500 mb-6 uppercase tracking-wider">
            Nền kinh tế bên bờ vực thẳm
          </h3>
          <p className="mb-4 leading-relaxed text-gray-400">
        ...
        {/* Page 11: Text */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={5}>
          <h3 className="text-2xl font-bold text-white mb-6 uppercase tracking-wider">
            Tiếng chuông cảnh tỉnh Kronstadt
          </h3>
          <p className="mb-4 leading-relaxed text-gray-400">
        ...
        {/* Page 13: Text */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={6}>
          <h3 className="text-2xl font-bold text-red-500 mb-6 uppercase tracking-wider">
            Đại hội X & Bước ngoặt lịch sử
          </h3>
          <p className="mb-4 leading-relaxed text-gray-400">
        ...
        {/* Page 15: Text */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={7}>
          <h3 className="text-2xl font-bold text-white mb-6 uppercase tracking-wider">
            Khai sinh Chính sách Kinh tế Mới
          </h3>
          <p className="mb-4 leading-relaxed text-gray-400">
        ...
        {/* Page 17: Text */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={8}>
          <h3 className="text-2xl font-bold text-red-500 mb-6 uppercase tracking-wider">
            Thuế lương thực: Cởi trói cho nông dân
          </h3>
          <p className="mb-4 leading-relaxed text-gray-400">
        ...
        {/* Page 19: Text */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={9}>
          <h3 className="text-2xl font-bold text-white mb-6 uppercase tracking-wider">
            Sự trỗi dậy của các "Nepmen"
          </h3>
          <p className="mb-4 leading-relaxed text-gray-400">
        ...
        {/* Page 21: Text */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={10}>
          <h3 className="text-2xl font-bold text-red-500 mb-6 uppercase tracking-wider">
            Chủ nghĩa tư bản nhà nước
          </h3>
          <p className="mb-4 leading-relaxed text-gray-400">
        ...
        {/* Page 23: Text */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={11}>
          <h3 className="text-2xl font-bold text-white mb-6 uppercase tracking-wider">
            Khủng hoảng "Cái Kéo" (1923)
          </h3>
          <p className="mb-4 leading-relaxed text-gray-400">
        ...
        {/* Page 25: Text */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={12}>
          <h3 className="text-2xl font-bold text-red-500 mb-6 uppercase tracking-wider">
            Lenin qua đời: Tổn thất vô giá
          </h3>
          <p className="mb-4 leading-relaxed text-gray-400">
        ...
        {/* Page 27: Text */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={13}>
          <h3 className="text-2xl font-bold text-white mb-6 uppercase tracking-wider">
            Công nghiệp phục hồi & Kế hoạch GOELRO
          </h3>
          <p className="mb-4 leading-relaxed text-gray-400">
        ...
        {/* Page 29: Text */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={14}>
          <h3 className="text-2xl font-bold text-red-500 mb-6 uppercase tracking-wider">
            Sự phân hóa nông thôn và vấn đề Phú nông
          </h3>
          <p className="mb-4 leading-relaxed text-gray-400">
        ...
        {/* Page 31: Text */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={15}>
          <h3 className="text-2xl font-bold text-white mb-6 uppercase tracking-wider">
            Kết thúc NEP: Tiến lên Công nghiệp hóa
          </h3>
          <p className="mb-4 leading-relaxed text-gray-400">
        ...
        {/* Page 33: Text */}
        <div className="w-[636px] h-[450px] relative shrink-0 overflow-hidden"><Page number={16}>
          <h3 className="text-3xl font-bold text-red-500 mb-6 font-sans">
            Di sản của NEP trong kinh tế hiện đại
          </h3>
          <p className="mb-4 leading-relaxed text-gray-400">
